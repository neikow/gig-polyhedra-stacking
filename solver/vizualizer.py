...
from solver.types import Solution, ProblemDefinition, Polyhedron, Piece, Placement
...
def visualize_solution(problem: ProblemDefinition, solution: Solution) -> None:
    ...
    for placement in solution.polyedres:
        ...
        draw_placement(ax, placement, piece)

    plt.show()


def draw_placement(ax: Axes3D, placement: Placement, piece: Piece):
